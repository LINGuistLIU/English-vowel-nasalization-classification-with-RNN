...
def parameterTune(n_hidden, n_iters, learning_rate, plotpath, n_letters, n_categories, all_categories, category_lines, seedNum=10):
    ...
    for seed in range(1, seedNum+1):
        ...
        LSTMclassifier.plotLosses(all_losses, plotpath+'test-LSTM_Trainingloss_plot_seed'+str(seed)+'.pdf')
...
if __name__ == '__main__':
    ...
    #plot the result
    datatype = 'CVC-vs-'+cxt
    plotname = plotpath + 'testCM_LSTM_'+ datatype + '.pdf' # name of the test result confusion matrix plot
